  ...
  return (
    <div className="min-h-screen bg-background text-on-surface font-body flex">
      ...
      <aside className="hidden lg:flex flex-col h-screen w-64 fixed left-0 top-0 bg-surface py-8 z-50 border-r border-white/5">
        <div className="px-6 mb-12 cursor-pointer" onClick={() => navigate('/')}>
          <span className="text-2xl font-bold tracking-tighter text-primary-container">
            NovaFlix <span className="text-white text-sm font-normal">Admin</span>
          </span>
        </div>
