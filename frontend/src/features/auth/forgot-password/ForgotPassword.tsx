...
import { useForgotPassword } from "@/src/features/auth/forgot-password/hooks/useForgotPassword";
    ...
    <div className="relative min-h-screen flex flex-col justify-center px-8 pt-16 pb-24">
      ...
      <header className="fixed top-0 left-0 w-full bg-surface flex items-center px-6 h-16 z-50">
        <div className="flex items-center gap-4">
          ...
          <h1 className="font-headline uppercase tracking-widest text-sm text-primary">
            NovaFlix
          </h1>
        </div>
      </header>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1604871000636-074fa5117945?q=80&w=3000&auto=format&fit=crop')",
        }}
      ></div>
    </div>
  );
