      ...
      <div className="relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            {/* Email Input */}
            <div className="group">
              <label className="block text-[0.75rem] font-label font-bold uppercase tracking-[0.05em] text-on-surface-variant mb-2 ml-1">Email Address</label>
              <input 
            ...
            <div className="group">
              <div className="flex justify-between items-center mb-2">
                <label className="block text-[0.75rem] font-label font-bold uppercase tracking-[0.05em] text-on-surface-variant ml-1">Password</label>
                <button 
          ...
          <div className="relative flex items-center py-4">
            ...
            <span className="flex-shrink mx-4 text-[0.65rem] font-label text-on-surface-variant uppercase tracking-[0.2em]">or continue with</span>
            <div className="flex-grow h-px bg-surface-container-highest"></div>
          </div>
          ...
          <div className="flex justify-center gap-6">
            {/* Google */}
            <button className="w-14 h-14 rounded-full flex items-center justify-center border border-outline-variant/15 bg-surface-container-high/40 backdrop-blur-md hover:bg-surface-container-highest transition-all duration-300 active:scale-90 group">
        ...
        <footer className="mt-12 text-center">
          <p className="text-on-surface-variant font-body text-sm">
            ...
            <button onClick={() => onNavigate('register')} className="text-primary font-bold hover:underline underline-offset-4 ml-1">Sign Up</button>
          </p>
        </footer>
      </div>
    </div>
