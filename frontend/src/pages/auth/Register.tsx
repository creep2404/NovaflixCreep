  ...
  return (
    <div className="relative min-h-screen flex flex-col pt-20 pb-10 px-6">
      ...
      <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 py-4 bg-transparent">
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => onNavigate('browse')}>
          <span className="text-2xl font-black tracking-tighter uppercase text-primary font-headline">NovaFlix</span>
        </div>
      </header>
      ...
      <div className="relative z-10 w-full max-w-md mx-auto flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="mt-12 mb-16 space-y-2">
          <h1 className="text-[3.5rem] font-extrabold leading-[1.1] tracking-[-0.02em] text-on-surface font-headline">
            Unleash <br/> Cinematic Art
          </h1>
          <p className="text-on-surface-variant font-body text-sm max-w-[280px]">
            Step into a curated world of high-definition narratives and visual excellence.
          </p>
        </div>
        ...
        <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
          <div className="space-y-6">
            ...
            <div className="group relative">
              <label className="block text-[0.6875rem] uppercase tracking-[0.05em] text-on-surface-variant mb-2">Full Name</label>
              <input 
            ...
            <div className="group relative">
              <label className="block text-[0.6875rem] uppercase tracking-[0.05em] text-on-surface-variant mb-2">Email Address</label>
              <input 
                className="w-full bg-transparent border-b border-outline-variant py-3 px-0 focus:outline-none focus:border-primary transition-all duration-300 placeholder:text-outline text-on-surface font-body" 
            ...
            <div className="group relative">
              <label className="block text-[0.6875rem] uppercase tracking-[0.05em] text-on-surface-variant mb-2">Password</label>
              <input 
                className="w-full bg-transparent border-b border-outline-variant py-3 px-0 focus:outline-none focus:border-primary transition-all duration-300 placeholder:text-outline text-on-surface font-body" 
                placeholder="••••••••" 
                type="password"
            ...
            <div className="group relative">
              <label className="block text-[0.6875rem] uppercase tracking-[0.05em] text-on-surface-variant mb-2">Confirm Password</label>
              <input 
                className="w-full bg-transparent border-b border-outline-variant py-3 px-0 focus:outline-none focus:border-primary transition-all duration-300 placeholder:text-outline text-on-surface font-body" 
                placeholder="••••••••" 
                type="password"
        ...
        <div className="mt-16 text-center">
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[0.6875rem] uppercase tracking-[0.1em] text-on-surface-variant">Or register with</span>
            <div className="h-[1px] flex-1 bg-outline-variant/30"></div>
          </div>
        ...
        <div className="mt-auto pt-20 text-center">
          <p className="text-on-surface-variant font-body text-sm">
            ...
            <button onClick={() => onNavigate('login')} className="text-primary font-bold ml-1 hover:underline underline-offset-4 transition-all">Sign In</button>
          </p>
        </div>
      </div>
    </div>
