...
export const MOCK_MOVIES: Movie[] = [
  {
    id: '1',
    title: 'VOID RUNNER',
    description: 'A rogue pilot navigates the treacherous outer rim, uncovering a conspiracy that threatens the very fabric of the galaxy. With time running out, she must assemble a crew of misfits to stop an ancient evil from awakening.',
    year: 2024,
    duration: '2h 15m',
    rating: '18+',
  ...
  },
  {
    id: '2',
    title: 'Neon Nights',
    description: 'In a cyberpunk metropolis, a detective hunts a serial killer who uses augmented reality to commit crimes.',
    year: 2023,
    duration: '1h 50m',
    rating: '16+',
  ...
  },
  {
    ...
    description: 'A psychological thriller about a woman who begins hearing voices after moving into an isolated cabin.',
    year: 2024,
    duration: '2h 05m',
    rating: '18+',
  ...
  },
  {
    ...
    description: 'The final mission to Mars goes terribly wrong when the crew discovers they are not alone.',
    year: 2022,
    duration: '2h 30m',
    rating: '13+',
    genres: ['Sci-Fi', 'Drama'],
  ...
  },
  {
    ...
    description: 'A group of elite thieves plan the ultimate robbery during a city-wide blackout.',
    year: 2023,
    duration: '1h 45m',
    rating: '16+',
    genres: ['Action', 'Crime'],
  ...
  },
  {
    ...
    description: 'A physicist accidentally creates a tear in spacetime, forcing him to confront alternate versions of himself.',
    year: 2024,
    duration: '2h 10m',
    rating: '13+',
